...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String ATOMSETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, ATOMSETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, ATOMSETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(ATOMSETTINGSNS, "interval");
            if(newInterval != null)
